...
import Papers from '~/assets/pictures/papers.webp';
...
class NavigationResource {
    ...
    public static get adminLinks(): ICardData[] {
        return [
            ...
            {
                title: 'Gestion de la presse',
                subtitle: 'Ajouter ou modifiez vos revue de presse',
                photo: Papers,
                btn1: 'Gérer',
                link1: '/admin/center?Table=Articles',
            },
            {
                ...
                photo: MediasPic,
                btn1: 'Gérer',
                link1: '/admin/center?Table=Medias',
            },
            {
                title: 'Réglages',
